...
class DynamicBuffer{
	...
	////////////////////////////////////////////////////////////////////
		update( newData = null ){
			let finalData	= new this.GLArray( newData || this.data ),
	...
	// Static Functions
	////////////////////////////////////////////////////////////////////
		static newFloat( bufID, comLen, startSize ){
			return new DynamicBuffer( bufID, gl.ctx.ARRAY_BUFFER, Float32Array, comLen, startSize );
		}

		static newElement( bufID, startSize ){
			return new DynamicBuffer( bufID, gl.ctx.ELEMENT_ARRAY_BUFFER, Uint16Array, 1, startSize );
	}
}
